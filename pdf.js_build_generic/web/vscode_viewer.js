...
/***/ (function(module, exports, __webpack_require__) {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              if (langElement) {
                ...
                // console.log(`pdf.js locale get ${_app_options.AppOptions.get('locale')}`);
                _context4.next = 3;
  ...
  function getPDFFileNameFromURL(url) {
    ...
    // console.log(`vscode-debug: getPDFFileNameFromURL ${url}`);
    var defaultFilename = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'document.pdf';
  
    if (typeof url !== 'string') {
      //console.log(`vscode-debug: /2 getPDFFileNameFromURL ${defaultFilename}`);
    ...
    if (suggestedFilename) {
      ...
      if (suggestedFilename.includes('%')) {
        try {
          ...
          console.log(`vscode-debug: catch getPDFFileNameFromURL ${ex}`);
        }
      }
    }
    console.log(`vscode-debug: /9 getPDFFileNameFromURL ${suggestedFilename || defaultFilename}`);
  ...
  // console.log(`pdfjs.debug renderer: ${defaultOptions.renderer.value}`);

  {
    ...
    // defaultOptions.locale.value = 'bs-BA';

    // console.log(`pdfjs.debug locale: ${defaultOptions.locale.value}`);
  }
  ...
  function renderPage(activeServiceOnEntry, pdfDocument, pageNumber, size) {
    ...
    console.log(`scratch canvas: ${scratchCanvas.width}, ${scratchCanvas.height}`);
    ctx.fillRect(0, 0, scratchCanvas.width, scratchCanvas.height);
    ctx.restore();

    console.log(`pdf.js debug renderPage: ${pageNumber}`);
    return pdfDocument.getPage(pageNumber).then(function (pdfPage) {
      ...
      console.log(`pdf.js renderContext: ${JSON.stringify(renderContext)}`);
      return pdfPage.render(renderContext).promise;
    }).then(function () {
      console.log(`render/3 ${width} : ${height}`);
      return {
        width: width,
        height: height
      };
  ...
  PDFPrintService.prototype = {
    layout: function layout() {
      ...
      console.log(`print body: ${JSON.stringify(body)}`);
      ...
      // console.log(`pageSize: ${pageSize.width} x ${pageSize.height}`);
